...
/**
 * Switches to the eslint.github.io repo and commits all outstanding changes but
 * does not push to the origin.
 * @returns {void}
 * @private
 */
function commitSite() {
...
/**
 * Creates a release version tag but does not push back to origin.
 * @returns {void}
 */
function ciRelease() {

    const releaseInfo = ReleaseOps.release(null, true);
